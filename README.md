...
Etape 3 - Créez un nouveau répertoire n'importe où dans votre système pour votre nouveau projet Laravel. Après cela, déplacez-vous sur le chemin où vous avez créé le nouveau répertoire et tapez la commande suivante pour installer Laravel:
